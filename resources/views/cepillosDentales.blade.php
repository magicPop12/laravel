...
<div class="container-fluid">
  <div class="container">
    <center>
            ...
            <h3 class="display-2">CEPILLOS DENTALES</h3>
            <br>
    </center>
<!--------------SIN PRODUCTOS    
    <div class="row">
      <div class="col-lg-4 col-sm-6">
        <img src="imagenes/plasticos/productos/AI-160.png" class="img-fluid">
      </div>
      <div class="col-lg-4 col-sm-6">
        <img src="imagenes/plasticos/productos/AI-200.png" class="img-fluid">
      </div>
      <div class="col-lg-4 col-sm-6">
